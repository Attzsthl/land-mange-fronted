! function(e, t) {
    ...
    ! function() {
            ...
            if (x) {
                ...
                if (!I) {
                    ...
                    var Z = function(e, t) {
                            ...
                            if (0 !== o)
                                if (R = (t - z[i]) / o, y)
                                    if (E = C[i], O = C[0 === i ? i : i - 1], q = C[i > x - 2 ? x - 1 : i + 1], B = C[i > x - 3 ? x - 1 : i + 2], w) l(O, E, q, B, R, R * R, R * R * R, g(e, d), A);
                                    else {
                                        var s;
        ...
        return s.prototype = {
            ...
            _animateToShallow: function(e, t, r, n, o) {
                var s = {},
                    l = 0;
                for (var c in r)
                    if (null != t[c]) a(r[c]) && !i.isArrayLike(r[c]) ? this._animateToShallow(e ? e + "." + c : c, t[c], r[c], n, o) : (s[c] = r[c], l++);
                    else if (null != r[c])
                    if (e) {
                        var u = {};
        ...
        var a = n.prototype;
        return a.updateView = a.updateLayout = a.updateVisual = function(e, t, i, r) {}, r.enableClassExtend(n), r.enableClassManagement(n, {
            registerWhenExtend: !0
        }), n
            ...
            drawRectText: function(e, n, o) {
                ...
                if (null != l && (l += ""), l) {
                    ...
                    var m = this.transform,
                        v = this.invTransform;
                    if (m && (a.copy(n), a.applyTransform(m), n = a, i(e, v)), h instanceof Array) c = n.x + t(h[0], n.width), u = n.y + t(h[1], n.height), p = p || "left", g = g || "top";
                    else {
        ...
        return a.updateData = function(e, t) {
            ...
            e.diff(o).add(function(r) {
                ...
                return i(e, l, t) ? (u ? (u.updateData(e, l), r.updateProps(u, {
                    position: h
                }, a)) : (u = new s(e, l), u.attr("position", h)), n.add(u), void e.setItemGraphicEl(l, u)) : void n.remove(u)
            }).remove(function(e) {
        ...
        var h = {
                ...
                axisTick: function() {
                    ...
                    if (e.get("axisTick.show")) {
                        for (var t = e.axis, i = e.getModel("axisTick"), r = this.opt, a = i.getModel("lineStyle"), o = i.get("length"), s = p(i, r.labelInterval), l = t.getTicksCoords(), c = [], u = 0; u < l.length; u++)
                            if (!d(t, u, s)) {
                                var h = l[u];
        ...
        var i = e("zrender/core/util"),
            ...
            c = e("../../echarts").extendComponentView({
                ...
                _splitLine: function(e, t, i) {
                    ...
                    for (var d = t.coordinateSystem.getRect(), p = n.isHorizontal(), f = [], g = 0, m = n.getTicksCoords(), v = [], y = [], x = 0; x < m.length; x++)
                        if (!a(n, x, h)) {
        ...
        s.updateData = function(e, t, r) {
            ...
            l.setStyle(o.defaults({
                fill: f
            }, p.getModel("normal").getItemStyle())), l.hoverStyle = p.getModel("emphasis").getItemStyle(), i(this, e.getItemLayout(t), u.get("selected"), c.get("selectedOffset"), c.get("animation")), l.off("mouseover").off("mouseout").off("emphasis").off("normal"), u.get("hoverAnimation") && l.on("mouseover", n).on("mouseout", s).on("emphasis", n).on("normal", s), this._updateLabel(e, t), a.setHoverStyle(this)
            ...
            r.setStyle(n(e, t, "normal", h)), r.ignore = r.normalIgnore = !h.get("show"), r.hoverIgnore = !d.get("show"), i.ignore = i.normalIgnore = !p.get("show"), i.hoverIgnore = !f.get("show"), i.setStyle({
                stroke: u
            }), i.setStyle(p.getModel("lineStyle").getLineStyle()), r.hoverStyle = n(e, t, "emphasis", d), i.hoverStyle = f.getModel("lineStyle").getLineStyle();
            var g = p.get("smooth");
        ...
        function s(e, t, i, r, n, s, l) {
            ...
            if (s && d.applyTransform(s.transform), "function" == typeof e && (e = e([t, i], n, d)), h.isArray(e)) t = f(e[0], c), i = f(e[1], u);
        ...
        return e("../../echarts").extendChartView({
            ...
            render: function(e, t, n) {
                ...
                if (!(c.length < 1)) {
                    ...
                    d.points.length !== c.length ? (p.points = a(), d.points = a(), i.initProps(h, f, e), i.initProps(u, f, e)) : (i.updateProps(h, f, e), i.updateProps(u, f, e)), this._symbolDraw.updateData(l), h.setStyle(r.extend(e.getModel("lineStyle.normal").getLineStyle(), {
                        stroke: l.getVisual("color")
                    }));
        ...
        for (var t = e("../Region"), i = [126, 25], r = [
            ...
            for (var a = 0; a < r[n].length; a++) r[n][a][0] /= 10.5, r[n][a][1] /= -14, r[n][a][0] += i[0], r[n][a][1] += i[1];
        return function(e) {
        ...
        var t = e("../echarts"),
            i = e("zrender/core/util");
        e("./graph/GraphSeries"), e("./graph/GraphView"), e("./graph/roamAction"), t.registerProcessor("filter", e("./graph/categoryFilter")), t.registerVisualCoding("chart", i.curry(e("../visual/symbol"), "graph", "circle", null)), t.registerVisualCoding("chart", e("./graph/categoryVisual")), t.registerLayout(e("./graph/simpleLayout")), t.registerLayout(e("./graph/circularLayout")), t.registerLayout(e("./graph/forceLayout")), t.registerCoordinateSystem("graphView", {
        ...
        a.updateData = function(e, t, i) {
            ...
            a.setStyle(n.defaults({
                fill: d
            }, h.getModel("normal").getItemStyle())), a.hoverStyle = h.getModel("emphasis").getItemStyle(), this._updateLabel(e, t), r.setHoverStyle(this)
            ...
            var h = s.getModel("label.normal"),
                ...
                p = s.getModel("labelLine.normal"),
                f = s.getModel("labelLine.emphasis");
            a.setStyle(i(e, t, "normal", h)), a.ignore = a.normalIgnore = !h.get("show"), a.hoverIgnore = !d.get("show"), n.ignore = n.normalIgnore = !p.get("show"), n.hoverIgnore = !f.get("show"), n.setStyle({
                stroke: u
            }), n.setStyle(p.getModel("lineStyle").getLineStyle()), a.hoverStyle = i(e, t, "emphasis", d), n.hoverStyle = f.getModel("lineStyle").getLineStyle()
        ...
        function r(e) {
            e.each(function(t) {
                ...
                if (d) r = (h[0][0] + h[1][0] + h[2][0] + h[3][0]) / 4, n = (h[0][1] + h[1][1] + h[2][1] + h[3][1]) / 4, i = "center", a = [
                    [r, n],
                    [r, n]
                ];
                else {
        ...
        return e("../../echarts").extendChartView({
            ...
            render: function(e, o, s) {
                ...
                p.formatTooltip = function(e) {
                    ...
                    }, a.getModel("itemStyle.normal").getItemStyle())), i.setHoverStyle(h, n.extend(t.getModel("itemStyle.emphasis"), {
        ...
        function c(e, t, i) {
            S.each(e, function(e) {
                ...
                if (n = o - t - i, n > 0) {
                    ...
                    for (r.setLayout({
                            y: l
                        }, !0), o = r.getLayout().y, a = s - 2; a >= 0; --a) r = e[a], n = r.getLayout().y + r.getLayout().dy + t - o, n > 0 && (l = r.getLayout().y - n, r.setLayout({
                        y: l
                    }, !0)), o = r.getLayout().y
                }
            })
        ...
        return c._updateEffectSymbol = function(e, t) {
            ...
            var u = a.get("color") || e.getItemVisual(t, "color"),
                h = this.childAt(1),
                d = 1e3 * a.get("period");
            (this._symbolType !== c || d !== this._period) && (h = s.createSymbol(c, -.5, -.5, 1, 1, u), h.ignore = !0, h.z2 = 100, this._symbolType = c, this._period = d, this.add(h), h.__t = 0, h.animate("", !0).when(d, {
                __t: 1
            }).delay(t / e.count() * d / 2).during(o.bind(r, h)).start()), h.setStyle("shadowColor", u), h.setStyle(a.getItemStyle(["color"])), h.attr("scale", l);
        ...
        function t() {
            ...
            this.canvas = e, this.blurSize = 30, this.pointSize = 20, this.opacity = 1, this._gradientPixels = {}
        }
        var i = 20,
            r = 256,
            n = e("zrender/core/util");
        return t.prototype = {
            update: function(e, t, n, a, o, s) {
                ...
                for (var b = p.getImageData(0, 0, d.width || 1, d.height || 1), w = b.data, M = 0, S = w.length; S > M;) {
                    var _ = w[M + 3] / 256,
            ...
            _getBrush: function() {
                ...
                return a.clearRect(0, 0, r, r), a.shadowOffsetX = r, a.shadowBlur = this.blurSize, a.shadowColor = "#000", a.beginPath(), a.arc(-t, t, this.pointSize, 0, 2 * Math.PI, !0), a.closePath(), a.fill(), e
            },
            ...
            completeVisualOption: function() {
                ...
                function r(e) {
                    ...
                    h(this.stateList, function(a) {
                        ...
                        c || (c = e[a] = {
                            color: g ? n : [n]
                        }), c.symbol || (c.symbol = i && t.clone(i) || (g ? "roundRect" : ["roundRect"])), c.symbolSize || (c.symbolSize = r && t.clone(r) || (g ? o[0] : [o[0], o[0]])), c.symbol = s(c.symbol, function(e) {
            ...
            i = {
                getItemAlign: function(e, i, r) {
                    ...
                    for (var o = {
                            ...
                            ["left", "right", "width"],
                            ["top", "bottom", "height"]
                        ], c = l[s], u = [0, null, 10], h = {}, d = 0; 3 > d; d++) h[l[1 - s][d]] = u[d], h[c[d]] = 2 === d ? r[0] : n[c[d]];
                    var p = [
                            ["x", "width", 3],
                            ["y", "height", 0]
                        ][s],
            ...
            o = {
                ...
                pieces: function() {
                    ...
                    r.each(e.pieces, function(e, t) {
                        ...
                        if (null != e.label && (a.text = e.label, i = !0), e.hasOwnProperty("value")) a.value = e.value, i || (a.text = this.formatValueText(a.value));
                        else {
                            var o = e.min,
                                s = e.max;
